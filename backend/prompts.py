...
GANG_ANALYSIS_SYSTEM_PROMPT = (
    ...
    "Feinden in Acht nehmen). (3) Schliesse mit einer eindringlichen Mahnung, "
    "die KLAR macht: die kommenden rund 222 Stunden entscheiden, welches "
    "Standing sie sich in der Stadt erarbeiten — jetzt zeigt sich, wo sie am "
