...
ALLOWED_STORY_FILES: dict[str, str] = {
    ...
    "CITY_PUBLIC_BRIEFING_DISCORD.md": "💬 Öffentlich · Discord-Kurzversion",
    "CITY_PUBLIC_BRIEFING_VOICEOVER.md": "🎙️ Öffentlich · Voiceover",
    "CITY_PUBLIC_BRIEFING_VOICEOVER_MULTI.md": "🎙️ Öffentlich · Voiceover (Multi-Voice)",
    "CITY_PUBLIC_BRIEFING_VOICEOVER_MOTION_COMIC.md": "🎬 Motion-Comic · Voiceover",
    "MOTION_COMIC_STORYBOARD.md": "🎬 Motion-Comic · Storyboard",
